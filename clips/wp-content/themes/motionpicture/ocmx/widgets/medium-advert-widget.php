...
class ocmx_medium_ad_widget extends WP_Widget {
    ...
    function ocmx_medium_ad_widget() {
		...
		$this->WP_Widget('ocmx_medium_ad_widget', __("(Obox) 300px Adverts"), $widget_ops);
    }
    ...
    function form($instance) {	
		...
		?>
        	...
        	<p><em>You can modify your sidebar ads in the <a href="admin.php?page=ocmx-adverts">Theme Options</a> panel</em></p>
        <?php 
    }
